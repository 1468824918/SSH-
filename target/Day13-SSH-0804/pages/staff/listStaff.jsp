			 ...
			 if (this.readyState === 4) {
				 ...
				 for (var i = 0; i < json.length; i++) {
                     ...
                     function createA() {
                         ...
                         var path = "${pageContext.request.contextPath}/updateStaff.action?staffId=";
                         path+=get_Id;
                         var td = document.createElement("td");
                         td.setAttribute("align", "center")
	  ...
	  <tr class="tabtd1">
	    ...
	    <td align="center">${s.post.postName}</td>
	  	<td width="7%" align="center">
	  		<a href="${pageContext.request.contextPath}/staffsFindDepartments.action?
 ...
 <%--<table border="0" cellspacing="0" cellpadding="0" align="center">--%>
	 <%--<tr>--%>
		 <%--<td align="right">--%>
			 ...
			 <%--<span>--%>
                <%--<a href="findStaffByPage">[首页]</a>&nbsp;&nbsp;--%>
            <%--<a href="findStaffByPage?pageNum=${session.pageBean.pageNum - 1}">[上一页]</a>&nbsp;&nbsp;--%>
                <%--<s:iterator begin="#session.pageBean.start" end="#session.pageBean.end" var="num">--%>
					<%--<s:if test="#num <= #session.pageBean.totalPage">--%>
                            <%--<a href="findStaffByPage?pageNum=${num}">--%>
            ...
            <%--<a--%>
					<%--<c:choose>--%>
						...
						<%--<c:otherwise>href="findStaffByPage?pageNum=${pageBean.pageNum + 1}"</c:otherwise>--%>
