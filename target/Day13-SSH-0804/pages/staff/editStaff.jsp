...
<%
	String a = request.getParameter("postId");
	String b = request.getParameter("postName");
	String c = request.getParameter("depID");
...
//		 data.append("postId",value);
		...
		xhr.open("POST", "findPostAll.action");
		xhr.send(data);
	}
</script>
</body>
