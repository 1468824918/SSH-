...
<form action="${pageContext.request.contextPath}/pages/student/showStudent.jsp" method="post">
	<!--  -->
	<input type="hidden" name="crmStudent.studentId" value="402881e84d47ffc9014d481b53860002" depID="runoffAction_add_crmStudent_studentId"/>
	<table width="88%" class="emp_table">
	  ...
	  <tr>
	    ...
	    <td width="200px" align="left">
	    	<select name="isRefund" depID="runoffAction_add_isRefund">
    ...
    <option value="0">不退</option>
	  ...
	  <tr>
	    ...
	    <td width="200px" align="left">
	    	<input type="text" name="refundAmount" value="" depID="runoffAction_add_refundAmount"/>
	    </td>
	    <td>&nbsp;</td>
	  </tr>
	  <tr>
	    ...
	    <td width="200px" align="left">
	    	<textarea name="remark" cols="20" rows="4" depID="runoffAction_add_remark"></textarea>
	    </td>
	    <td>&nbsp;</td>
	  </tr>
	</table>
