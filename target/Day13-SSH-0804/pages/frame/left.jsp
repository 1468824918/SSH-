...
<div class="dtree">
	<script type="text/javascript">
		...
		d.add('0105','01','人力资源部');
		d.add('010501','0105','部门管理','${pageContext.request.contextPath}/findDepartmentByPage.action','','right');
		d.add('010502','0105','职务管理','${pageContext.request.contextPath}/findPostByPage.action','','right');
		d.add('010503','0105','员工管理','${pageContext.request.contextPath}/staffFindDepartment.action','','right');
