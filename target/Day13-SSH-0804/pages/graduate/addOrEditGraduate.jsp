...
<form action="${pageContext.request.contextPath}/pages/graduate/listGraduate.jsp" method="post">
	<table width="88%" border="0" class="emp_table" style="width:80%;">
	  ...
	  <tr>
	    <td width="9%">学生：</td>
	    <td width="19%"><select depID="studentSelectId" name="crmStudent.studentId" ><option>--选择学生--</option></select></td>
	    <td>&nbsp;</td>
	  </tr>
	  <tr>
	    <td>就业公司：</td>
	  ...
	  <tr>
	    <td colspan="3">
	    	<textarea name="remark" cols="60" rows="10" depID="graduateAction_addOrEdit_remark"></textarea>
	    </td>
	  </tr>
	</table>
</form>
