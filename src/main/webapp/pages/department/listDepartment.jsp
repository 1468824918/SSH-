...
<table width="100%" border="1" >
  ...
  <tr class="henglan" style="font-weight:bold;">
    ...
    <s:iterator value="#session.pageBean.data" var="dept">
	  <tr class="tabtd2">
	    <td align="center">${dept.depName} </td>
	  	<td width="7%" align="center">
	  		<a href="action.action?&depName=${dept.depName}&depID=${dept.depID}"><img src="${pageContext.request.contextPath}/images/button/modify.gif" class="img"/></a>
	  	</td>
	  </tr>
    </s:iterator>
...
>[下一页]</a>&nbsp;&nbsp;
<a href="findDepartmentByPage?pageNum=${pageBean.totalPage}">[尾页]</a>
</span>
         </td>
     </tr>
 </table>
