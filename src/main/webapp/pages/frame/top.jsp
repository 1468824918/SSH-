...
<table border="0" width="100%" cellspacing="0" cellpadding="0" depID="table1" height="27">
	<tr>
		<td>
		<table border="0" width="100%" cellspacing="0" cellpadding="0" depID="table2">
			<tr>
				...
				<table border="0" width="100%" cellspacing="0" cellpadding="0" depID="table4">
					<tr>
						<td height="19">
						</td>
					</tr>
					...
					<tr>
						<td>
						<div align="right">
							<table border="0" width="215" cellspacing="0" cellpadding="0" depID="table6" height="23">
								<tr>
							...
							<table border="0" width="215" cellspacing="0" cellpadding="0" depID="table6" height="23">
								<tr>
									<td width="51" valign="middle">
										...
										--%>
										<a href="${pageContext.request.contextPath}/passJsp.action" target="right">
											<font color="ffffff">更改密码</font>
										</a>
									</td>
										<td width="55" valign="middle"><a href="${pageContext.request.contextPath}/againLogin.action" target="_top">
...
<table border="0" width="100%" cellspacing="0" cellpadding="0" height="10" depID="table3">
	<tr>
